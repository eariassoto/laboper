...
%include "Stage2/stdio.inc"			; basic i/o routines
%include "Stage2/Gdt.inc"			; Gdt routines
%include "Stage2/A20.inc"			; A20 enabling
%include "Stage2/Fat12.inc"			; FAT12 driver. Kinda :)
